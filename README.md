...
**NoMQ** (No Message Queue) is a lightweight, secure, and scalable messaging protocol designed for Internet of Things (IoT) applications. Built for resource-constrained devices running MicroPython, NoMQ provides enterprise-grade security, reliable message delivery, and real-time communication without the overhead of traditional message brokers.
...
### Prerequisites
- **Hardware**: Any MicroPython  microcontroller.
...
async def main():
    try:
        ...
        await nomq.publish(
            ...
            qos=2,
            retain=True,
            ip="255.255.255.255", #OR Device IP 
            port=8888,
            signature=signature,
        )
